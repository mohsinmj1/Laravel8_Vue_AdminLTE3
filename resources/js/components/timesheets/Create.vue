                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mt-2" style="border-bottom:1px solid #D3D3D3">
                            ...
                            <div class="col-lg-1">
                                <button id="startbtn" class="btn btn-success py-0 px-3" data-toggle="modal" data-target="#modal-start-time" style="line-height:26px;" >Start</button>
                        ...
                        <div class="row mt-2" style="border-bottom:1px solid #D3D3D3">
                            ...
                            <div class="col-lg-1">
                                <button id="startbtn" class="btn btn-success py-0 px-3" style="line-height:26px;" >Start</button>
                                <input id="startTime" type="text" style="width:79px;display:none" placeholder="hh:mm">
                            </div>
                            <div class="col-lg-1">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                 <input type="text" id="workTime" val="" style="border: 0px solid;" readonly>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" id="getBreakTime" val="" style="border: 0px solid;" readonly>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-4">End : </div>
                            <div class="col-md-4"><input type="text" style="border: 0px solid;" id="getEndTime" val="" readonly></div>
                        </div>
            ...
            startfn: function(event) {
                    ...
                    if(event==1){
                        ...
                        clearInterval(myTimer);
                         ...
                         var Btime = dt.getHours() + ":" + dt.getMinutes() + ":" + dt.getSeconds();
                        ...
                        $('#getBreakTimeInBreakModal').val(Btime);
                         ...
                         $('#modalBreakBtn').hide();
                          $('#modalContinueBtn').hide();
                           $('#modalfinishBtn').hide();
                           $('#modalBreakBtn').hide();
                    var timee = dte.getHours() + ":" + dte.getMinutes() + ":" + dte.getSeconds();
                        total_break=$('#getBreakTime').val();
                        total_time=$('#workTime').val();
                    ...
                    function setTime() {
                       //var todayDate = moment(new Date()).format("MM-DD-YYYY"); //Instead of today date, We can pass whatever date        
                        ...
                        var Currenttime = dtt.getHours() + ":" + dtt.getMinutes() + ":" + dtt.getSeconds();
                       ...
                       //var todayDate = moment(new Date()).format("MM-DD-YYYY"); //Instead of today date, We can pass whatever date        
                        ...
                        var Currenttime = dtt1.getHours() + ":" + dtt1.getMinutes() + ":" + dtt1.getSeconds();
                        var startDate = new Date(`${todayDate} ${time}`);
                        var endDate = new Date(`${todayDate } ${Currenttime}`);
