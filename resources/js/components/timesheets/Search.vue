                ...
                <div class="card-body">
                    <ul class="nav nav-tabs" id="custom-content-below-tab" role="tablist">
                        <li class="nav-item" style="width:33%">
                            <a class="nav-link active" id="custom-content-below-general-tab" data-toggle="pill" href="#custom-content-below-general" role="tab" aria-controls="custom-content-below-general" aria-selected="true">Main Filter</a>
                        </li>
                        <li class="nav-item" style="width:33%;border-bottom:blue">
                            <a class="nav-link" id="custom-content-below-timesheet-tab" data-toggle="pill" href="#custom-content-below-timesheet" role="tab" aria-controls="custom-content-below-timesheet" aria-selected="false">Date Ranges</a>
                        </li>
                        <li class="nav-item" style="width:33%">
                            <a class="nav-link" id="custom-content-below-expenses-tab" data-toggle="pill" href="#custom-content-below-expenses" role="tab" aria-controls="custom-content-below-expenses" aria-selected="false">ID/Ref Ranges</a>
                        </li>
