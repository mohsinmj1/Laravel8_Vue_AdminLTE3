                ...
                <div class="tab-content" id="custom-content-below-tabContent">
                    <div class="tab-pane fade active show" id="custom-content-below-main" role="tabpanel" aria-labelledby="custom-content-below-main-tab">
                        ...
                        <div class="row">
                             ...
                             <div class="col-lg-2" style="padding-top:32px;"> 
                                <div class="custom-control custom-checkbox">
                                    ...
                                    <label class="custom-control-label" for="customCheck1">Unmatched Advice Notes</label>
                                </div>
                            </div> 
                             <div class="col-lg-2" style="padding-top:32px;"> 
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input" id="customCheck1">
                                    <label class="custom-control-label" for="customCheck1">Written-off Advice Notes</label>
                                </div>
                            </div> 
                        </div>
                        <br>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3">
                                <label for="client" class="d-block mb-1">Payment Application Status</label>
                                <select class="form-control select2">                                    
                                    <option value="1">All</option>
