                  ...
                  <div class="card card-primary card-outline card-tabs">
                    <div class="row">
                      <div class="col-lg-12">
                        <div class="p-2 pl-4">
                          <div class="timesheet_create_tit">
                            <h2 class="pb-2">Default Values</h2>
                          </div>
                          <div class="row">
                            <div class="col-lg-6">
                              <label for="client" class="d-block mb-1"
                              ...
                              <select class="form-control form-control-sm">
                                ...
                                <option value="weekly_thurs-wed">
                                  weekly_thurs-wed
                                </option>
                                <option value="weekly_fri-thurs">
                                  weekly_fri-thurs
                                </option>
                                <option value="weekly_sat-fri">
                                  weekly_sat-fri
                                </option>
                                <option value="weekly_sun-sat">
                                  weekly_sun-sat
                                </option>
                                <option value="two-weekly">two-weekly</option>
                                <option value="four-weekly">four-weekly</option>
                                <option value="monthly">monthly</option>
                                <option value="half-monthly-16th">
                                  half-monthly-16th
                                </option>
                          ...
                          <div class="row">
                            <div class="col-lg-12">
                              <label for="client" class="d-block mb-1"
                                >Default Timesheet Approval Route</label
                              >
                              <select class="form-control form-control-sm">
                                <option value="">Agency Default</option>
                                <option value="2372">
                          ...
                          <div class="row">
                            <div class="col-lg-12">
                              <label for="client" class="d-block mb-1"
                                >Default Chargeable Expense Approval
                                Route</label
                              >
                              <select class="form-control form-control-sm">
                          ...
                          <div class="row">
                            <div class="col-lg-12">
                              <label for="client" class="d-block mb-1"
                                >Default Non Chargeable Expense Approval
                                Route</label
                              >
                              <select class="form-control form-control-sm">
                                <option value="">Agency Default</option>
